...
With your consent, the assistant can search catalogues, look up stock locations, on-hand, and WAC (reads), draft requisitions, add items to a buy list, and export reports.
