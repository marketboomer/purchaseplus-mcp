...
Use it to connect Cursor, Claude, ChatGPT, and other MCP-capable clients to PurchasePlus. With purchaser access, an assistant can search catalogues, list delivery addresses, draft requisitions, add items to a buy list, and export reports.
